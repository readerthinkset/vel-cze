"""
Migrate phrase history to Czech format
Converts legacy keys ('japanese', 'telugu', 'korean') -> 'czech'
...
if HISTORY_FILE.exists():
    ...
    print(f"Migrated {updated_count} phrases to Czech format")
    if updated_count > 0:
    ...
    print("Ready for new Czech content generation")
else:
